...
class PrintDocument{
  ...
  pdf.Widget _buildSalePdf(Sale sale, Local local, TaxPayer taxPayer, invoice, ticket) {
  ...
  pdf.Widget _buildPresalePdf(Presale presale, Local local, TaxPayer taxPayer) {
